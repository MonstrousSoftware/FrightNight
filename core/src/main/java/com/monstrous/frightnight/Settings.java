...
public class Settings {
    ...
    static public boolean skipTitleScreen = false;           // also skips ExitScreen
    ...
    static public float lightningPeriod = 4f;          // period of lightning (randomized: average will be half this)
